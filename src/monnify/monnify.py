...
#     baseUrl: str = "https://sandbox.monnify.com" if credentials['is_live'] == False else "https://api.monnify.com"
#     url = f"{baseUrl}/api/v1/auth/login"
#     _string = f"{credentials['api_key']}:{credentials['secret_key']}"
#     _string_bytes = _string.encode("ascii")
#     base64_bytes = base64.b64encode(_string_bytes)
#     base64_string = base64_bytes.decode("ascii")
#     encoded = base64_string  # text=f"{self.__apiKey}:{self.__secretKey}"
#     headers = {
